...
add = ("Добавь в список дел следующее", "добавь в список дел следующее", "Добавь в список дел", "добавь в список дел",
       "Добавь в мой список дел следующее", "добавь в мой список дел следующее", "Добавь в мой список дел",
       "добавь в мой список дел", "Добавить в список дел следующее", "добавить в список дел следующее",
       "Добавить в список дел", "добавить в список дел", "Добавить в мой список дел", "добавить в мой список дел")
show = ("Покажи список дел", "покажи список дел", "Покажи мой список дел", "покажи мой список дел")
delete = ("Очисти список дел", "очисти список дел", "Очисти мой список дел", "очисти мой список дел",
          "Удали мой список дел", "удали мой список дел", "Удали список дел", "удали список дел")
