...
record = ("Запиши аудио", "запиши аудио", "Запиши с микрофона", "запиши с микрофона", "Запиши звук с микрофона",
          "запиши звук с микрофона", "Сделай аудиозапись", "сделай аудиозапись")
