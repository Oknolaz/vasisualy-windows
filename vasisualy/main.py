...
from .skills import (skill_loader, time_date, exit, weather, music, open, screenshot, search, poweroff, ytvideo,
                     resay, map, wiki, location, weather_no_city, translate, news, coin, shoplist, todolist,
                     netconnection, record, guess_num, rulette, math, crystal_ball, random_num, timer,
